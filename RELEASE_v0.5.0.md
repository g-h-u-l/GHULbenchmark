...
- Public access will be enabled once the frontend is complete

If you try to use `--share` and receive an "access-denied" message, this is expected behavior. The feature will be fully enabled in a future release.
